defmodule VoidWeb.CoreComponents do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-zinc-50/90 dark:bg-gray-900/80 fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div
          ...
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            ...
            >
              <div class="absolute top-6 right-5">
                ...
                >
                  <.icon name="hero-x-mark-solid" class="h-5 w-5 dark:text-zinc-50" />
                </button>
              </div>
              <div id={"#{@id}-content"}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VoidWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VoidWeb.Gettext, "errors", msg, opts)
    end
  end
